...
export default function UpdateUserForm() {
  ...
  if(Object.keys(formData).length>0) return <Success message={"Data Added"}/>
    ...
    >
      ...
      <button
      className="flex justify-center text-md w-2/6 bg-yellow-500 text-white px-4 py-2 gap-2 border rounded-md hover:bg-gray-50 hover:text-yellow-500 hover:border-yellow-500"
      >Update<BiBrush size={23} /> </button>
    </form>
  );
}
